...
class GoogleScraper {
    ...
    _isScrollable(page) {
        return page.evaluate(() => {
            return (
                document.querySelector("#islmp input[type='button']") !== null
            );
        });
    }
    ...
    _isButtonVisible(page) {
        return page.evaluate(() => {
            ...
            return isVisible(
                document.querySelector("#islmp input[type='button']"),
            );
        });
    }
    ...
    _parseLinksFromHTML(html) {
        ...
        $('#islrg div[jsaction][data-tbnid]').each(function (
            _i,
            containerElement,
        ) {
            ...
            const parsedLink = url.parse(linkElementHref, {
